...
{"pger",       0, INSN_CLASS_I,   "d,e",     MATCH_PGER,     MASK_PGER, match_opcode, 0 },
{"pser",       0, INSN_CLASS_I,   "f,s",     MATCH_PSER,     MASK_PSER, match_opcode, 0 },
{"pmv.p.p",    0, INSN_CLASS_I,   "h,g",     MATCH_PMV_P_P,  MASK_PMV_P_P, match_opcode, 0 },
{"padd",       0, INSN_CLASS_I,   "h,g,y,W", MATCH_PADD,     MASK_PADD, match_opcode, 0 },
{"prnd",       0, INSN_CLASS_I,   "h,g,W",   MATCH_PRND,     MASK_PRND, match_opcode, 0 },
{"psub",       0, INSN_CLASS_I,   "h,g,y,W", MATCH_PSUB,     MASK_PSUB, match_opcode, 0 },
{"pmul",       0, INSN_CLASS_I,   "h,g,y,W", MATCH_PMUL,     MASK_PMUL, match_opcode, 0 },
{"ple",        0, INSN_CLASS_I,   "h,X,s,G", MATCH_LOAD_VPE, MASK_LOAD_VPE, match_opcode, 0 },
{"plh",        0, INSN_CLASS_I,   "h,Y,s,G", MATCH_LOAD_VPH, MASK_LOAD_VPH, match_opcode, 0 },
{"plw",        0, INSN_CLASS_I,   "h,Y,s,G", MATCH_LOAD_VPW, MASK_LOAD_VPW, match_opcode, 0 },
{"pld",        0, INSN_CLASS_I,   "h,Y,s,G", MATCH_LOAD_VPD, MASK_LOAD_VPD, match_opcode, 0 },
{"pse",        0, INSN_CLASS_I,   "y,X,s,H", MATCH_STORE_VPE, MASK_STORE_VPE, match_opcode, 0 },
{"psh",        0, INSN_CLASS_I,   "y,Y,s,H", MATCH_STORE_VPH, MASK_STORE_VPH, match_opcode, 0 },
{"psw",        0, INSN_CLASS_I,   "y,Y,s,H", MATCH_STORE_VPW, MASK_STORE_VPW, match_opcode, 0 },
{"psd",        0, INSN_CLASS_I,   "y,Y,s,H", MATCH_STORE_VPD, MASK_STORE_VPD, match_opcode, 0 },
{"pcmp.eq",    0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP_EQ,   MASK_PCMP_EQ, match_opcode, 0 },
{"pcmp.neq",   0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP_NEQ,  MASK_PCMP_NEQ, match_opcode, 0 },
{"pcmp.geq",   0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP_GEQ,  MASK_PCMP_GEQ, match_opcode, 0 },
{"pcmp.gt",    0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP_GT,   MASK_PCMP_GT, match_opcode, 0 },
{"pcmp.leq",   0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP_LEQ,  MASK_PCMP_LEQ, match_opcode, 0 },
{"pcmp.lt",    0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP_LT,   MASK_PCMP_LT, match_opcode, 0 },
{"pcmp",       0, INSN_CLASS_I,   "d,g,y",   MATCH_PCMP,      MASK_PCMP, match_opcode, 0 },
{"pcvt.p.h",   0, INSN_CLASS_I,   "d,y,Y",   MATCH_PCVT_P_H,  MASK_PCVT_P_H, match_opcode, 0 },
{"pcvt.p.f",   0, INSN_CLASS_I,   "d,y,Y",   MATCH_PCVT_P_F,  MASK_PCVT_P_F, match_opcode, 0 },
{"pcvt.p.d",   0, INSN_CLASS_I,   "d,y,Y",   MATCH_PCVT_P_D,  MASK_PCVT_P_D, match_opcode, 0 },
{"pcvt.h.p",   0, INSN_CLASS_I,   "h,s",     MATCH_PCVT_H_P,  MASK_PCVT_H_P, match_opcode, 0 },
{"pcvt.f.p",   0, INSN_CLASS_I,   "h,s",     MATCH_PCVT_F_P,  MASK_PCVT_F_P, match_opcode, 0 },
{"pcvt.d.p",   0, INSN_CLASS_I,   "h,s",     MATCH_PCVT_D_P,  MASK_PCVT_D_P, match_opcode, 0 },
{"pmv.p.x",    0, INSN_CLASS_I,   "d,g,J",   MATCH_PMV_P_X,   MASK_PMV_P_X, match_opcode, 0 },
{"pmv.psgn.x", 0, INSN_CLASS_I,   "d,g",     MATCH_PMV_PSGN_X,MASK_PMV_PSGN_X, match_opcode, 0 },
{"pmv.psum.x", 0, INSN_CLASS_I,   "d,g,J",   MATCH_PMV_PSUM_X,MASK_PMV_PSUM_X, match_opcode, 0 },
{"pmv.plen.x", 0, INSN_CLASS_I,   "d,g",     MATCH_PMV_PLEN_X,MASK_PMV_PLEN_X, match_opcode, 0 },
{"pmv.pexp.x", 0, INSN_CLASS_I,   "d,g",     MATCH_PMV_PEXP_X,MASK_PMV_PEXP_X, match_opcode, 0 },
{"pmv.x.p",    0, INSN_CLASS_I,   "h,s,J",   MATCH_PMV_X_P,   MASK_PMV_X_P, match_opcode, 0 },
{"pmv.x.psgn", 0, INSN_CLASS_I,   "h,s",     MATCH_PMV_X_PSGN,MASK_PMV_X_PSGN, match_opcode, 0 },
{"pmv.x.psum", 0, INSN_CLASS_I,   "h,s",     MATCH_PMV_X_PSUM,MASK_PMV_X_PSUM, match_opcode, 0 },
{"pmv.x.plen", 0, INSN_CLASS_I,   "h,s",     MATCH_PMV_X_PLEN,MASK_PMV_X_PLEN, match_opcode, 0 },
{"pmv.x.pexp", 0, INSN_CLASS_I,   "h,s",     MATCH_PMV_X_PEXP,MASK_PMV_X_PEXP, match_opcode, 0 },
